...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h1>XML Data</h1>
                                <a id="button" class="btn btn-primary" role="button" href="#">Retrieve data with ajax</a>
				<hr>
<div id="content">
    <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
        <li class="active"><a href="#ewallet" data-toggle="tab">Ewallet</a></li>
        <li><a href="#transaction" data-toggle="tab">Transaction info</a></li>
        <li><a href="#paymentdetails" data-toggle="tab">Payment details</a></li>
        <li><a href="#customer" data-toggle="tab">Customer info</a></li>
        <li><a href="#customer-delivery" data-toggle="tab">Customer delivery</a></li>
        <li><a href="#shopping-cart" data-toggle="tab">Shopping cart</a></li>
    </ul>
    <div id="show-data" hidden></div>
    <div id="my-tab-content" class="tab-content" hidden>
        <div class="tab-pane active" id="ewallet">
            <h1>Ewallet</h1>
        ...
        <div class="tab-pane" id="customer-delivery">
...
jQuery.createXMLDocument = function(string) {
    ...
    return doc;
            ...
            function addData(type, data) {
                    var items = $(data.children).find(type);
                    $("#"+type).find(".api-data").empty();
                    items.children().each(function() {
                        var name = this.nodeName;
                        $("#"+type).find(".api-data").append("<p>" + name + ": " + $(this).text() + "</p>");
                    });
                    $("#my-tab-content").show();
            }

            function addDataShoppingCart(data) {
                    console.log(data);
                    var items = $(data.children).find('shopping-cart').find('items');
                    $("#shopping-cart").find(".api-data").empty();
                    items.find('item').find('item').each(function(key, value) {
                        $("#shopping-cart").find(".api-data").append("<h3>Item</h3><hr>");
                        console.log(value);
                        $.each(value.children, function(index, el) {
                        ...
                        //var doc = $.createXMLDocument(value);
                        //console.log(doc);
                        //$(doc).children().each(function() {
                            //var name = this.nodeName;
                            //$("#shopping-cart").find(".api-data").append("<p>" + name + ": " + $(this).text() + "</p>");
                        //});
                    });
                    $("#my-tab-content").show();
            }
            ...
            $.ajax({
                ...
                success: function(data) {
                    //var items = $(data.children).find("ewallet");
                    addData("ewallet", data);
                    addData("customer", data);
                    addData("customer-delivery", data);
                    addData("transaction", data);
                    addData("paymentdetails", data);
                    addDataShoppingCart(data);
                },
                error: function() {
