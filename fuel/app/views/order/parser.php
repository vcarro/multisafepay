...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h1>XML Data</h1>
                                <a id="button" href="#">Retrive data</a>
                                <a id="button2" href="#">Retrive data with ajax</a>
				<hr>
<div id="content">
    <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
        <li class="active"><a href="#ewallet" data-toggle="tab">Ewallet</a></li>
        <li><a href="#transaction_info" data-toggle="tab">Transaction info</a></li>
        <li><a href="#payment_details" data-toggle="tab">Payment details</a></li>
        <li><a href="#customer_info" data-toggle="tab">Customer info</a></li>
        <li><a href="#customer_delivery" data-toggle="tab">Customer delivery</a></li>
        <li><a href="#shopping_cart" data-toggle="tab">Shopping cart</a></li>
    </ul>
    <div id="show-data" hidden></div>
    <div id="my-tab-content" class="tab-content" hidden>
        <div class="tab-pane active" id="ewallet">
            <h1>Ewallet</h1>
            <p><?php //foreach($data['ewallet'] as $clave => $valor) {
                     //echo $clave . ": " . $valor . "<br/>"; 
                 //}
             ?></p>
        ...
        <div class="tab-pane" id="transaction_info">
            ...
            <p><?php foreach($data['transaction'] as $clave => $valor) {
                     echo $clave . ": " . $valor . "<br/>"; 
                 }
             ?></p>
        </div>
        <div class="tab-pane" id="payment_details">
            ...
            <p><?php foreach($data['paymentdetails'] as $clave => $valor) {
                     echo $clave . ": " . $valor . "<br/>"; 
                 }
             ?></p>
        </div>
        <div class="tab-pane" id="customer_info">
            <h1>Customer info</h1>
            <p><?php foreach($data['customer'] as $clave => $valor) {
                     echo $clave . ": " . $valor . "<br/>"; 
                 }
             ?></p>
        </div>
        <div class="tab-pane" id="customer_delivery">
            <h1>Customer delivery</h1>
            <p><?php foreach($data['customer-delivery'] as $clave => $valor) {
                     echo $clave . ": " . $valor . "<br/>"; 
                 }
             ?></p>
        </div>
        <div class="tab-pane" id="shopping_cart">
            <h1>Shopping Cart</h1>
            <p><?php $items = $data['checkoutdata']['shopping-cart']['items']['item'];
                     foreach($items as $item) {
                         echo "<h2>Item</h2>";
                         echo "<hr>";
                         displayRecursiveResults($item);
                     }
        ...
        <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#ewallet").find(".api-data").empty();
                    items.children().each(function() {
                        var name = this.nodeName;
                        $("#ewallet").find(".api-data").append("<p>" + name + ": " + $(this).text() + "</p>");
                    });
                    $("#my-tab-content").show();
                },
                error: function() {
